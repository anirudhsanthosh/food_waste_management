...
INSERT INTO "new_Election" ("createdAt", "description", "id", "status", "title", "updatedAt", "user_id") SELECT "createdAt", "description", "id", "status", "title", "updatedAt", "user_id" FROM "Election";
DROP TABLE "Election";
