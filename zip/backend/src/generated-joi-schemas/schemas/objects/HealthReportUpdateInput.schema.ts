...
import { UserUpdateOneRequiredWithoutHealthReportsNestedInputSchemaObject } from './UserUpdateOneRequiredWithoutHealthReportsNestedInput.schema'

export const HealthReportUpdateInputSchemaObject = {
...
Joi.object().keys(NullableIntFieldUpdateOperationsInputSchemaObject)),
  ...
  user: Joi.object().keys(UserUpdateOneRequiredWithoutHealthReportsNestedInputSchemaObject)
}